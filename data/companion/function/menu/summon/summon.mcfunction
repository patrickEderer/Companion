...
$summon item_display ~ ~ ~ {Tags:["menu","menu-item","menu-item-i-2","companion-entity"],Glowing:1b,glow_color_override:17669,interpolation_duration:5,view_range:0.01f,transformation:{left_rotation:[0.0f,1.0f,0.0f,0f],right_rotation:[0.0f,1.0f,0.0f,0f],translation:[$(x2)f,$(y2)f,$(z2)f],scale:[0.125f,0.125f,0.125f]},item:{id:"minecraft:paper",count:1}}
$summon marker ~$(x2) ~$(y2) ~$(z2) {Tags:["menu","menu-item-selection","menu-item-i-2","companion-entity"],data:{menu_item_tag:"menu-item-i-2"}}

$summon item_display ~ ~ ~ {Tags:["menu","menu-item","menu-item-i-3","companion-entity"],Glowing:1b,glow_color_override:17669,interpolation_duration:5,view_range:0.01f,transformation:{left_rotation:[0.0f,1.0f,0.0f,0f],right_rotation:[0.0f,1.0f,0.0f,0f],translation:[$(x3)f,$(y3)f,$(z3)f],scale:[0.125f,0.125f,0.125f]},item:{id:"minecraft:paper",count:1}}
$summon marker ~$(x3) ~$(y3) ~$(z3) {Tags:["menu","menu-item-selection","menu-item-i-3","companion-entity"],data:{menu_item_tag:"menu-item-i-3"}}

$summon item_display ~ ~ ~ {Tags:["menu","menu-item","menu-item-i-4","companion-entity"],Glowing:1b,glow_color_override:17669,interpolation_duration:5,view_range:0.01f,transformation:{left_rotation:[0.0f,1.0f,0.0f,0f],right_rotation:[0.0f,1.0f,0.0f,0f],translation:[$(x4)f,$(y4)f,$(z4)f],scale:[0.125f,0.125f,0.125f]},item:{id:"minecraft:paper",count:1}}
...
$function util:store_temp_value {"n":"pitch","v":"$(pitch0)"}
$function util:store_temp_value {"n":"yaw","v":"$(yaw0)"}

# Half values
execute store result storage util:temp temp.pitch float 1 run data get storage util:temp temp.pitch 0.5
execute store result storage util:temp temp.yaw float 1 run data get storage util:temp temp.yaw 0.5

function math:save_rotation/calc with storage util:temp temp
