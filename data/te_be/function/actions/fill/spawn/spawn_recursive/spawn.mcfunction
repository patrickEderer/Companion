...
#check settings
execute if score .outline operation_settings matches 1 run function te_be:actions/fill/spawn/spawn_recursive/settings/check_outline
execute if score .wall operation_settings matches 1 run function te_be:actions/fill/spawn/spawn_recursive/settings/check_wall
function te_be:actions/fill/spawn/spawn_recursive/settings/check_outside
