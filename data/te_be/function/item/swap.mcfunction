...
execute if data entity @s equipment.offhand.components.minecraft:custom_data.start run function te_be:item/item_replace_end
execute if data entity @s equipment.offhand.components.minecraft:custom_data.end run function te_be:item/item_replace_start
